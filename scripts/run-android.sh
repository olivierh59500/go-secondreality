...
go run github.com/hajimehoshi/ebiten/v2/cmd/ebitenmobile@v2.9.11 \
    ...
    -androidapi 23 \
    -javapkg com.olivierh.secondreality \
    -o android/app/libs/secondreality.aar \
    ./mobile
...
echo "→ Lancement de Second Reality"
$adb_path shell am force-stop com.olivierh.secondreality
$adb_path shell am start -n com.olivierh.secondreality/.MainActivity
